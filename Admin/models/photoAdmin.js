...
module.exports.insertPhoto = function(numero,data, callback) {
    db.getConnection(function(err, connexion) {
        if (!err) {
            let sql = "INSERT INTO photo (PHOTO_NUMERO, VIP_NUMERO, PHOTO_SUJET, PHOTO_COMMENTAIRE, PHOTO_ADRESSE) VALUES ("+numero.NB+","+data.vip+", '"+data.subject+ "', '"+data.com_img+"', '"+data.img+"')";console.log(sql);
